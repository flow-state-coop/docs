...
:::tip Why do I need to connect my shares?
...
:::tip A full list of deployed Super Tokens across networks is available on the Superfluid [Explorer](https://explorer.superfluid.finance/base-mainnet/supertokens).
